package com.tinymonster.heartbeat3.view;
...
public class StepArcView extends View {
    ...
    private void drawArcYellow(Canvas canvas, RectF rectF) {
        ...
        /** 默认画笔颜色，黄色 */
        paint.setColor(getResources().getColor(R.color.change_blue));
        /** 结合处为圆弧*/
    ...
    private void drawTextNumber(Canvas canvas, float centerX) {
        ...
        vTextPaint.setColor(getResources().getColor(R.color.drawer_white));
